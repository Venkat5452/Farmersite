...
function Products() {
     ...
     const onFormSubmit=(userdata)=>{
       //HTTP POST REQUEST
       axios.post('http://localhost:4000/product/create-product',userdata)
       .then(Response=>{
     ...
     return (
        <div className='row mt-3'>
          <p className='display-4 text-danger text-center'>ENTER CROP DETAILS To Add To The DATABASE</p>
          <div className='col-9 col-sm-8 col-md-6 mx-auto mt-2'>
          <img src='https://images.pexels.com/photos/162870/rye-cereals-wheat-nature-162870.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'width="100%" height="350" className='rounded-3 responsive' alt=''/>
            <form onSubmit={handleSubmit(onFormSubmit)}>
              ...
              <button type="submit" className='btn btn-success w-50'>Submit<FcCheckmark/></button> <Button onClick={routeChange} variant="secondary" size="sm">   To Update Product</Button>
            </form>
          </div>  
        </div>
    )
